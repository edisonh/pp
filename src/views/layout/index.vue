  ...
  <n-layout has-sider v-resize @resize="handleResize">
    ...
    >
      <a href="https://mypikpak.com/" target="_blank" class="logo-box">
       <img src="../../assets/apple-touch-icon.png" class="logo-box__icon" alt="">
...
import { File, Trash, CircleX, Logout, Settings, Share, Copy, Video, Camera, FileSearch } from '@vicons/tabler'
